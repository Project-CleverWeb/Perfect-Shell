...
**Description :**  
The idea is to create an easily customizable shell that is easy to read, cross OS compatible/consistent, and has git integration.
